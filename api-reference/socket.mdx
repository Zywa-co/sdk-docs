...
* **WebSocket Endpoint:** Use the Cozmox real-time transcription endpoint (for on-demand SaaS, e.g. **`wss://mea.cozmox.ai/v2`**). Enterprise deployments may use a different regional endpoint.
