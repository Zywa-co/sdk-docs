...
* **WebSocket Endpoint:** Use the Cozmox real-time transcription endpoint (for on-demand SaaS, e.g. **`wss://eu2.rt.Cozmox.com/v2`**). Enterprise deployments may use a different regional endpoint.
