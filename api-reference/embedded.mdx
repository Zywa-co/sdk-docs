...
## Security
Do not embed the x-api-key on your frontend. Instead, create an internal API that acts as a proxy to the CozmoxAPI
It is also recommended to set up some form of captcha, Cloudlfare Turnstile is a good option that can be verified on 
your internal API to reduce misuse of public facing embeddings of the agent.
